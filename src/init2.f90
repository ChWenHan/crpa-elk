...
! equal k- and q-point grids for nesting function, BSE and linear-reposnse TDDFT
  ngridq(:)=ngridk(:)
else if ((xctype(1).lt.0).or.(any(task.eq.[5,300,600,620,630,653]))) then
...
if ((xctype(1).lt.0).or.(any(task.eq.[5,205,240,241,300,600,620,630,651,652,653,654]))) then
